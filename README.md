...
An interactive web application is also available, providing a user-friendly interface to utilize the power of PyDB. Visit [website](https://pydb-8pbbc.ondigitalocean.app/) to access the web application and explore its features.

## Usage

To use PyDB in your Python project, follow these steps:

1. Clone the repository: `git clone https://github.com/Flo-Devv/PyDB`
